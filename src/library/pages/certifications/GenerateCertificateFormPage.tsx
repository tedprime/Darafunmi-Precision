...
const GenerateCertificateFormPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    getCertification(editId)
      .then(
        (
          cert: { data?: Record<string, unknown> } & Record<string, unknown>,
        ) => {
          if (cancelled) return;
          ...
          setCalDate(
            d.calibrationDate ? str(d.calibrationDate).slice(0, 10) : "",
          );
          ...
          setRecDate(
            d.recommendedRecalibDate
              ? str(d.recommendedRecalibDate).slice(0, 10)
              : "",
          );
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (calibrationResults.length === 0) {
      toast.error(
        "Please add at least one calibration result row with a standard value.",
      );
      return;
    }
    ...
    try {
      ...
      toast.error(
        err instanceof Error
          ? err.message
          : `Failed to ${isEditMode ? "update" : "create"} certificate.`,
      );
    } finally {
      setSubmitting(false);
    }
      ...
      {loadingCert ? (
        ...
        <>
          ...
          <div className="flex items-center mb-6">
            <span className={tab("form")} onClick={() => setActiveTab("form")}>
              Form
            </span>
            <span
              ...
              {!hasPreviewData ? (
                ...
                <>
                  <div id="cert-preview" style={s.page}>
                      ...
                      <div style={s.body}>
                        ...
                        <div style={s.section}>
                          <div style={s.eqRow}>
                            ...
                            <span style={s.eqValue}>{d.equipCalibrated}</span>
                          </div>
                          <div style={s.eqRow}>
                        ...
                        <div style={{ marginBottom: 10 }}>
                          <div style={s.bulletWrap}>
                            ...
                            <p style={s.bulletText}>
                              This is to certify that the instrument described
                              above has been calibrated against Physical
                              Laboratory Standards, which is traceable to
                              Standard Organization of Nigeria (SON) at National
                          ...
                          <div style={s.bulletWrap}>
                            <span style={s.bulletArrow}>&#9658;</span>
                            <p style={s.bulletText}>
                              The Reference Instruments used was verified by
                              Weight and Measure under the ACT. 1990 CAP467 of
                              Federal Republic of Nigeria with Certificate No:{" "}
                    ...
                    <div style={s.footer}>
                      <p style={{ margin: 0 }}>
                        Calibration, Laboratory/Medical Equipment, Process
                        Analytical Instrument Services, Repairs, Maintenance,
                        Training &amp; Sales
                      </p>
                      <p style={{ margin: 0 }}>
                        CAL LAB: Suite D4 &amp; D5, Beside Tantalizer, Opp.
                        Queen Esther Hall, Km 46, Lagos-Ibadab Express Way,
