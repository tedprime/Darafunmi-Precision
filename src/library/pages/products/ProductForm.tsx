// Shared form used by both AddProductPage and EditProductPage
...
const CATEGORIES = [
  ...
  { label: "Pressure Instruments", value: "pressure instruments" },
  { label: "Temperature Instruments", value: "temperature instruments" },
  { label: "Flow Instruments", value: "flow instruments" },
  { label: "Analytical Instruments", value: "analytical instruments" },
  { label: "Electrical Instruments", value: "electrical instruments" },
  { label: "Calibration Equipment", value: "calibration equipment" },
];
    ...
    <form onSubmit={handleSubmit}>
      ...
      <Card className="mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
          ...
          <Input id="price" label="Price" placeholder="Enter price" type="number"
            value={price} onChange={(e) => setPrice(e.target.value)} />
          <Input id="stock" label="Stock Quantity" placeholder="Enter stock quantity" type="number"
      ...
      <div className="flex space-x-4">
        ...
        <Button type="button" variant="secondary" onClick={() => navigate("/products")} disabled={submitting}>
          Cancel
        </Button>
      </div>
    </form>
